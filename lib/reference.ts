    ...
    blocks: [
      {
        ...
        steps: [
          ...
          },
          {
            ...
            text: `You decide whether this is the round to spend a charged flagship weapon. Each costs ${TUNING.weaponChargeCost} Energy to charge in the shipyard. Each flagship weapon once a game. Only one per round. Use it after rolling and before locking in.`,
          },
          {
            name: "4. Lock in",
